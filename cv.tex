...
% ## {My team is responsible of cloud & on-premise infrastructures on which rely several RTL group streaming platforms and also the French streaming platform Salto.

% ## multiple AWS regions
% ## FinOps to reduce costs as much as possible
% ## terraform to control AWS, GCP or Fastly resources (100K lines of code)
% ## several kubernetes clusters
% ## * using HAProxy ingress controller
% ## * VPC CNI to take best advantage of AWS networks
% ## 
% ## migration all apps in the cloud (all but fronts + bo + data + video)
% ## repair kubernetes failures (NAT, DNS)
% ## stabilizing kubernetes autoscaling + metrics + logging + ingress
% ## 
% ## Preparing Salto platform: restricted access to a lot of micro-services, opening external video contributions
% ## 
% ## 
% ## multi-tenant:
