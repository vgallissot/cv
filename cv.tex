...
{I work on the microservices architecture behind several RTL group's Catch-up TV websites (www.6play.fr, www.rtlmost.hu, play.rtl.hr, www.rtlplay.be). We use Kubernetes inside AWS cloud platform to keep scaling.
\begin{itemize}
...
\cventry{Jun 2015 - Jun 2017}{Linux Systems Administrator}{PEAKS}{Lyon (France)}{NSA team (4pers)}
...
\cvitemwithcomment{English}{level BULATS B2 (2012)}{}
