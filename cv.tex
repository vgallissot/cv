...
\section{Conferences}
\cvitem{2022}{\textit{Speaker:}
    \href{https://www.dropbox.com/s/thvtayaltp0d6s5/IN-02_AWS_SUMMIT_BedrockStreaming_2022-full.pdf}
    {
        \textcolor{blue}{AWS Summit Paris}
    }
    \href{https://www.slideshare.net/VincentGallissot/scaling-bedrock-video-delivery-to-50-million-users-with-haproxy}
    {
        / \textcolor{blue}{HAProxy Conf Paris}
    }
    \href{https://www.youtube.com/watch?v=5jzOXlmRDao}
    {
        (watch \faPlay)
    }
}
...
\cvitem{2019}{\textit{Speaker:}
    ...
    / Peaks meetup Lyon
    \href{https://www.slideshare.net/VincentGallissot/20191112-haproxy-conf-2019-rtl-journey-to-kubernetes-with-haproxy}
    {
...
\cvlistdoubleitem{Alpine skiing}{Climbing}
